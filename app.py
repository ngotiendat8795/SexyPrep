...
@app.route('/ic<id1>/r<id2>', methods=["GET", "POST"])
def highlight_template(id1, id2):

    Test_ID = "IC"+str(id1)+"_T"+str(id2)
    Test_Content = reading_test.find_one({"Test_ID": Test_ID})
    return render_template('text_highlighter.html', Test_Content=Test_Content, session = session)
